        ...
        <div class="w-full md:w-1/2 p-4">
            ...
            <form id="questionForm" class="max-w-screen-md mb-4">
                ...
                <div class="flex flex-col md:flex-row items-center border-b border-teal-500 py-2">
                    <input
                        class="appearance-none bg-transparent border-none w-full text-gray-700 mr-1 py-1 px-2 leading-tight  focus:outline-none focus:ring-0"
                        type="text" name="question" placeholder="أدخل سؤالك" required>
                    <div class="flex items-center mr-1 ml-1">
                        <select id="language" name="language"
                            class="mt-2 md:mt-0 block w-full md:w-auto rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6 mr-4">
